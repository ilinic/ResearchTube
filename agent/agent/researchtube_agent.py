...
class SpeechTaskManager:
    ...
    def google_progress(self, task_id: str, payload: Any) -> dict[str, Any]:
        ...
        messages = {"openingTranslate": "Opening Google Translate.", "playing": "Playing Google Translate speech.", "recording": "Recording Google Translate tab audio.", "saving": "Saving recorded Google Translate speech."}
