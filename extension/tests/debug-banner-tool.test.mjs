...
assert.match(background, /name: "researchtube_check_debug_banner"/);
...
assert.match(background, /executeToolCall\(request\.id, "researchtube_check_debug_banner", \{\}, getDebugBannerStatus\)/);
