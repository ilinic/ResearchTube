...
assert.equal(agentInterfaceIsCompatible({ available: true, interfaceVersion: 6 }), true);
assert.equal(agentInterfaceIsCompatible({ available: true, interfaceVersion: 5 }), false);
