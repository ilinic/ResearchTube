...
const MCP_TOOL_SETTINGS = Object.freeze({
  ...
  media_probe: { group: "media" }, media_capture_frame: { group: "media" }, media_visual_map_create: { group: "media" }, media_visual_map_get_task: { group: "media" }, media_capture_screen: { group: "media" }, media_image_crop: { group: "media" }, media_show_workspace_image: { group: "media" }, media_inspect_image: { group: "media" },
...
const EXTENSION_VERSION = "1.71.0";
const REQUIRED_AGENT_INTERFACE_VERSION = 41;
