...
const PAGE_BRIDGE_VERSION = "1.2.2";
...
async function handleMcpRequest(request) {
  ...
  if (request?.method === "tools/call" && request.params?.name === "youtube_get_transcript") {
    return executeToolCall(request.id, () => {
      ...
      return youtubeGetTranscript(requireVideoId(args), boundedInt(args.limit, 800, 1, 5000));
    });
  }
